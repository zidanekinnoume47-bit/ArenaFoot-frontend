...
function Room() {
  ...
  const submitResult = async () => {
    ...
    try {
      // CORRECTION : Passage de axios.put à axios.post pour correspondre au backend
      ...
      console.log("Erreur résultat :", error);
      ...
      {room ? (
        <>
          <div className="room-card">
            ...
            <div className="code">{room.room_code || "En attente"}</div>
            ...
            <button onClick={submitResult}>Valider le résultat</button>
          </div>
        </>
      ) : (
